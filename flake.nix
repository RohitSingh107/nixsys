{
  ...
  in {
    ...
    darwinConfigurations = {
      "Mishras-MacBook-Air" = nix-darwin.lib.darwinSystem {
        specialArgs = {inherit inputs outputs;};
        modules = [
          ./darwin/Mishras-MacBook-Air/configuration.nix
        ];
      };
    };
    ...
    homeConfigurations = {
      ...
      "rohits@hp15seq" = home-manager.lib.homeManagerConfiguration {
      ...
      "rohit@ubuntu-wsl" = home-manager.lib.homeManagerConfiguration {
        pkgs = nixpkgs.legacyPackages.x86_64-linux; # Home-manager requires 'pkgs' instance
        extraSpecialArgs = {inherit inputs outputs;};
        modules = [
          # > Our main home-manager configuration file <
          ./home-manager/ubuntu-wsl/rohit/home.nix
        ];
      };
      "azureuser@scripts-vm" = home-manager.lib.homeManagerConfiguration {
        pkgs = nixpkgs.legacyPackages.x86_64-linux; # Home-manager requires 'pkgs' instance
        extraSpecialArgs = {inherit inputs outputs;};
        modules = [
          # > Our main home-manager configuration file <
          ./home-manager/cloud-vms/scripts-vm/azureuser.nix
        ];
      };
